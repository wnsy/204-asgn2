...
We split the data into two parts - a section for exploration and training, and another for testing. Will do an arbitrary 50-50 split using the sample function
...
We should start by looking at some basic descriptive information about the data: Using EDA to gain a better understanding of our data
```{r EDA.1, echo=TRUE}
...
Then we are looking to plot the response to see if it is well-shaped and distributed nicely 
```{r EDA.2, echo=TRUE}
